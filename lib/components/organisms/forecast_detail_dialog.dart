...
class _ForecastDetailDialogState extends State<ForecastDetailDialog> {
  ...
  void initState() {
    ...
    widget.dailyForecast.listen((event) {
      List<DateTime> dates = distinctDates(event);
                      ...
                      builder: (context, snapshot) {
                        ...
                        return StreamBuilder(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<FlSpot> spots = dataPointToSpots(forecasts);
                            if (spots.isEmpty) {
                              return Center(
                                child: Text(
                                  widget.t.hourlyForecastNotAvailable,
                  ...
                  Container(
                    ...
                    child: StreamBuilder(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<DateTime> dates = distinctDates(forecasts);
                          ...
                          children: [
                            for (var i = 0;
                              ...
                              Row(
                                ...
                                children: [
                                  for (var j = 0; j < daysPerPager; j++)
                                    if (dates.length > (i * daysPerPager + j))
